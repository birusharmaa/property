        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-12">
                    ...
                    <div class="card p-4">
                        <table id="agentleadcommission"
                            class="table table-striped display dataTable table-hover"
                            style="width:100%">
                            <div class="align1 pb-2">
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    href="#agentleadmodal2" type="submit">Add User</button>
                            </div>
                            <thead>
...
<!-- First modal dialog -->
<div class="modal fade" id="agentleadmodal2" aria-hidden="true" aria-labelledby="agentleadmdl2"
    tabindex="-1">
