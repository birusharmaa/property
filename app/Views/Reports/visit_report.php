            ...
            <div class="">
                <div class="col-md-12 p-0 m-auto">
                    <!-- <div class="red-bg text-center text-white rounded py-2 mb-3">
                        <h1 class=" fw-bolder">Visit Report</h1>
                    </div> -->
                </div>
                <div class="col-md-12 m-auto card py-4 px-4">
                    <div class="row border border-bottom border-0 border-2  py-3 mb-3 rounded ">
                        ...
                        <div class="col-md-3 mt-4  text-center">
                            <button class="btn red-bg text-white w-100 fw-bold">Visit Report</button>
                        </div>
                        <div class="col-md-3 mt-4  text-center">
...
<script>
    ...
    var chart = new ApexCharts(document.querySelector("#total-visit-report"), visitreport);
    chart.render();
</script>
