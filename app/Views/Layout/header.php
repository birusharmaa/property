            ...
            <div class="h-right justify-content-end d-flex align-items-center">
                                    ...
                                    <ul class="list-unstyled list mb-0">
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="https://alui.thememakker.com/html/public/assets/images/xs/avatar1.jpg" alt="">
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="https://alui.thememakker.com/html/public/assets/images/xs/avatar3.jpg" alt="">
                                                <div class="flex-fill ms-3">
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="https://alui.thememakker.com/html/public/assets/images/xs/avatar4.jpg" alt="">
                                                <div class="flex-fill ms-3">
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="https://alui.thememakker.com/html/public/assets/images/xs/avatar5.jpg" alt="">
                                                <div class="flex-fill ms-3">
                                                    <p class="d-flex justify-content-between mb-0 color-700"><span>Hammer</span> <small>13MIN</small></p>
                                        ...
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="https://alui.thememakker.com/html/public/assets/images/xs/avatar6.jpg" alt="">
                                                <div class="flex-fill ms-3">
                                                    <p class="d-flex justify-content-between mb-0 color-700"><span>Lentz</span> <small>1HR</small></p>
                                                    <span class="text-muted">There are many variations of passages</span>
                                                </div>
                                        ...
                                        <li class="py-2">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="https://alui.thememakker.com/html/public/assets/images/xs/avatar7.jpg" alt="">
                                                <div class="flex-fill ms-3">
                ...
                <div class="dropdown user-profile ms-2">
                    <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown">
                        <img class="avatar rounded-circle p-1" src="https://alui.thememakker.com/html/public/assets/images/profile_av.png" alt="">
                    </a>
                    <div class="dropdown-menu rounded-lg shadow border-0 dropdown-menu-end">
                        <div class="card border-0 w240">
                            <div class="card-body border-bottom">
                                <div class="d-flex py-1">
                                    <img class="avatar rounded-circle" src="https://alui.thememakker.com/html/public/assets/images/profile_av.png" alt="">
                                    <div class="flex-fill ms-3">
