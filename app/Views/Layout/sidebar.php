            ...
            foreach ($sidebar_menu as $main_menu) :
                ...
                if (isset($main_menu["name"])) :
                    ...
                    <li class="<?= $hide . " " . $collapsed; ?>">
                        ...
                        ?>
                        <a class="m-link <?= $a; ?>" data-bs-toggle="<?= $collapse; ?>" href="<?= $href ?>" aria-expanded="false" aria-controls="sidebar<?= $main_menu['name'] ?>" <?php echo $target; ?> href="<?= $href; ?>" data-bs-target="#<?= $collapse_target_pro; ?>">
                            <div class="col-2">
                            ...
                            <ul class="collapse sub-menu" id="<?= $collapse_target_pro; ?>">
                                <?php foreach ($submenu as $s_menu) :
                                    if (isset($s_menu['name'])) :
                                        ...
                                        <li class="collapsed">
                                            <a class="ms-link" <?= $str . " " . $sub_menu_target; ?> href="<?= $tr; ?>">
                                            ...
                                            <?php if (count($s_menu['sub_sub_menu']) > 0) {
                                                ...
                                                foreach ($s_menu['sub_sub_menu'] as $ss_m_menu) {
                                                    $href = $ss_m_menu['url']?base_url($ss_m_menu['url']):$ss_m_menu['url'];
                                                    if(!empty($ss_m_menu['url']))
                                                        echo '<li><a class="ms-link" href="' . $href . '">' . $ss_m_menu['name'] . '</a></li>';
                                                }
                                                echo "</ul>";
                                            } ?>
                                        </li>
