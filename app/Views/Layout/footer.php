<div class="body-footer px-xl-4 px-md-2">
    <div class="container-fluid">
        <div class="card mb-3" style="box-shadow: none!important;
">
            <div class="card-body">
                <div class="row justify-content-between align-items-center">
                    <div class="col">
                        <p class="font-size-sm mb-0">© <span class="d-none d-sm-inline-block"><script>document.write(/\d{4}/.exec(Date())[0])</script> Sartia Global.</span></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-header">
                    ...
                    <div class="setting-theme">
                        ...
                        <ul class="list-unstyled d-flex justify-content-between choose-skin mb-2 mt-1">
                            <li data-theme="navy" class="active"><div class="navy"></div></li>
                    ...
                    <div class="setting-img mb-3">
                        ...
                        <div class="bg-images">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li class="sidebar-img-1 sidebar-img-active"><a class="rounded sidebar-img" id="img-1" href="#"><img src="https://alui.thememakker.com/html/assets/images/sidebar-bg/sidebar-1.jpg" alt="" /></a></li>
                                <li class="sidebar-img-2"><a class="rounded sidebar-img" id="img-2" href="#"><img src="https://alui.thememakker.com/html/assets/images/sidebar-bg/sidebar-2.jpg" alt="" /></a></li>
                                <li class="sidebar-img-3"><a class="rounded sidebar-img" id="img-3" href="#"><img src="https://alui.thememakker.com/html/assets/images/sidebar-bg/sidebar-3.jpg" alt="" /></a></li>
                                <li class="sidebar-img-4"><a class="rounded sidebar-img" id="img-4" href="#"><img src="https://alui.thememakker.com/html/assets/images/sidebar-bg/sidebar-4.jpg" alt="" /></a></li>
                                <li class="sidebar-img-5"><a class="rounded sidebar-img" id="img-5" href="#"><img src="https://alui.thememakker.com/html/assets/images/sidebar-bg/sidebar-5.jpg" alt="" /></a></li>
                            </ul>
                        </div>
                    </div>
