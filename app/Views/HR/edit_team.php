                                    ...
                                    <form class="row g-3">
                                        <div class="col-md-6">
                                            <label for="teamname" class="form-label fw-bold">Team
                                                Name</label>
                                            <input type="text" id="teamname" class="form-control form-control1" value="Vikrant Singh" required>
                                        </div>
                                        <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <label for="radio-card-1" class="radio-card">
                                                            <input type="checkbox" name="radio-card" id="radio-card-1" checked />
                                                            <div class="card-content-wrapper" data-bs-toggle="tooltip" data-bs-placement="top" title="Name Id">
                                                                <span class="check-icon"></span>
                                                                <div class="card-content">
                                                                    <img src="<?= base_url(); ?>/assets/img/avatar1.jpg" alt="" class="rounded" />
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="radio-card-2" class="radio-card">
                                                            <input type="checkbox" name="radio-card" id="radio-card-2" checked />
                                                            <div class="card-content-wrapper" data-bs-toggle="tooltip" data-bs-placement="top" title="Name Id">
                                                                <span class="check-icon"></span>
                                                                <div class="card-content">
                                                                    <img src="<?= base_url(); ?>/assets/img/avatar2.jpg" alt="" class="rounded" />
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="radio-card-3" class="radio-card">
                                                            <input type="checkbox" name="radio-card" id="radio-card-3" checked />
                                                            <div class="card-content-wrapper" data-bs-toggle="tooltip" data-bs-placement="top" title="Name Id">
                                                                <span class="check-icon"></span>
                                                                <div class="card-content">
                                                                    <img src="<?= base_url(); ?>/assets/img/avatar1.jpg" alt="" class="rounded" />
                                                    ...
                                                    <div class="col-md-2">
                                                        <label for="radio-card-4" class="radio-card">
                                                            <input type="checkbox" name="radio-card" id="radio-card-4" />
                                                            <div class="card-content-wrapper" data-bs-toggle="tooltip" data-bs-placement="top" title="Name Id">
                                                                <span class="check-icon"></span>
                                                                <div class="card-content">
                                                                    <img src="<?= base_url(); ?>/assets/img/avatar2.jpg" alt="" class="rounded" />
                                                    ...
                                                    <div class="col-md-2">
                                                        <label for="radio-card-5" class="radio-card">
                                                            <input type="checkbox" name="radio-card" id="radio-card-5" />
                                                            <div class="card-content-wrapper" data-bs-toggle="tooltip" data-bs-placement="top" title="Name Id">
                                                                <span class="check-icon"></span>
                                                                <div class="card-content">
                                                                    <img src="<?= base_url(); ?>/assets/img/avatar1.jpg" alt="" class="rounded" />
                                                    ...
                                                    <div class="col-md-2">
                                                        <label for="radio-card-6" class="radio-card">
                                                            <input type="checkbox" name="radio-card" id="radio-card-6" />
                                                            <div class="card-content-wrapper" data-bs-toggle="tooltip" data-bs-placement="top" title="Name Id">
                                                                <span class="check-icon"></span>
                                                                <div class="card-content">
                                                                    <img src="<?= base_url(); ?>/assets/img/avatar2.jpg" alt="" class="rounded" />
