                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            ...
                            <div class="card p-4">
                                <table id="roles" class="table display dataTable table-hover"
                                    style="width:100%">
                                    <div class="align1 pb-2">
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                            href="#rolesmodal2" type="submit">Add Roles</button>
                                    </div>
                                    <thead>
                                        <tr class="py-3">
                                            <th>#ID</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Name 1</td>
                                            <td>Name <span class="badge bg-warning">dashboard</span> <span
                                                    class="badge bg-danger">designation</span> <span
                                                    class="badge bg-info">leads</span> <span
                                                    class="badge bg-success">payrol</span></td>
                                            <td>
                                                <a href="">
                                                    <i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="">
                                                    <i
                                                        class="fa fa-trash-o delete-details text-white text-center rounded bg-danger"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
