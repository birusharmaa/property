                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <div class="owl-carousel owl-theme" id="OwlBasicAutoplay">
                                    ...
                                    ?>
                                        <div class="item"><img class="img-fluid img-thumbnail" src="<?= base_url(); ?>/assets/public/img/property4.jfif" alt="">
                                        </div>

                                        <div class="itm">
                                            <video width="250" height="200" class="img-fluid" controls>
                                                <source src="<?= base_url(); ?>/assets/public/img/video.mp4 " type="video/mp4">
                                            </video>
                                        </div>
                                        <div class="item"><img class="img-fluid img-thumbnail" src="<?= base_url(); ?>/assets/public/img/property3.jpg" alt="">
                                        </div>
                                        <div class="item"><img class="img-fluid img-thumbnail" src="<?= base_url(); ?>/assets/public/img/property4.jfif" alt="">
                                        </div>
                                        <div class="item"><img class="img-fluid img-thumbnail" src="<?= base_url(); ?>/assets/public/img/property1.jpeg" alt="">
                                        </div>
                                        <div class="item"><img class="img-fluid img-thumbnail" src="<?= base_url(); ?>/assets/public/img/property4.jfif" alt="">
                                        </div>
                                        <div class="item"><img class="img-fluid img-thumbnail" src="<?= base_url(); ?>/assets/public/img/property3.jpg" alt="">
