        ...
        <div class="row">
            <div class="col-md-11 p-0 m-auto">
                <div class="red-bg text-center text-white rounded py-2 my-3">
                    <h1 class=" fw-bolder">Income Report</h1>
                </div>
            </div>
            <div class="col-md-11 m-auto bg-white py-4 px-4">
                <div class="row mx-auto border border-bottom border-0 border-2 bg-white py-3 mb-3 rounded ">
                    ...
                    <div class="col-md-3 mt-4  text-center">
                        <button class="btn red-bg text-white w-100 fw-bold">Generate Income</button>
                    </div>
                    <div class="col-md-3 mt-4  text-center">
...
<script>
    ...
    var chart = new ApexCharts(document.querySelector("#total-income"), incomeOption);
        chart.render();
</script>
